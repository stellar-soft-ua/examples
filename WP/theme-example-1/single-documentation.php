...
$related_content  = get_post_meta($post->ID, 'related-documentation')[0];
            ...
            <div class="post__wrap">
                <div class="post__description">
                    ...
                    <div class="post__text">
                        <?= $content ?>
                        <?php if ( $button_link = get_post_meta( $post->ID, 'documentation_button_link' )[0] ):
                            $button_text = get_post_meta( $post->ID, 'documentation_button_text' )[0] ?>
                ...
                <?php if ($related_content): ?>
                    <div class="related-posts">
                        ...
                        <?php foreach ($related_posts as $related): ?>
                            <?php $documentation_description = get_post_meta($related->ID, 'documentation_description')[0]; ?>
                                    ...
                                    <div class="product-preview__text">
                                        ...
                                        <div class="hover-block hover-block--posts">
                                            <div class="hover-block__text">
                                                <?php if ($documentation_description): ?>
                                                    <div class="ellipsis">
                                                        <p>
                                                            <?= wp_strip_all_tags($documentation_description) ?>
                                                        </p>
                                                    </div>
                                                <?php else: ?>
                                                    <div class="ellipsis">
