                    ...
                    <div class="product-preview__text">
                        ...
                        <div class="hover-block hover-block--posts">
                            <div class="hover-block__text">
                                <div>
                                    <p class="blog-short-description"><?= get_post_custom_values('documentation_description', $post->ID)[0] ?></p>
                                </div>
                            </div>
...
wp_enqueue_script('cmt-search-documentation-posts',get_template_directory_uri().'/assets/js/documentation-posts-search.js',['cmt-jquery'],false,true);
get_footer(); ?>
