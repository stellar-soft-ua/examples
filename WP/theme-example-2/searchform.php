 ...
 */
$search_text = apply_filters( 'genesis_search_text', __( 'Search Our Site...', 'genesis' ) );
 ...
 */
$search_button_text = apply_filters( 'genesis_search_button_text', esc_attr__( 'Go', 'genesis' ) );
